package com.webdevelopment.config;
...
import com.webdevelopment.serialization.converter.YamlJackson2HttpMessageConverter;
...
//			.allowedMethods("GET", "POST", "PUT")
				.allowedMethods("*").allowedOriginPatterns(allowedOrigins).allowCredentials(true);
